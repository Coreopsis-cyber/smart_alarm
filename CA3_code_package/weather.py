...
def get_weather() -> dict:
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            logging.error(excep + "Valid JSON file cannot be retrieved as likely invalid API key")
    ...
    if weather_notification not in global_variables.old_weather_notifs:
        ...
        logging.info(weather_notification["content"] + " was added to the notification list")
